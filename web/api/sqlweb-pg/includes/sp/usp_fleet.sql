...
-- Service envia: CompanyId, BranchId
-- Retorna: recordset unico con todas las alertas unificadas + conteos en la primera fila
...
-- Service envia: CompanyId, BranchId, Year, Month
