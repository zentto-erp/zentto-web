...
DROP FUNCTION IF EXISTS", cr."DeviceName";
...
DROP FUNCTION IF EXISTS     = p_device_name,
...
DROP FUNCTION IF EXISTS", cc."AutoCapture", cc."AllowRefunds", cc."MaxRefundDays",
...
DROP FUNCTION IF EXISTSblic.usp_pay_companyconfig_upsert(integer, character varying, boolean, text) CASCADE;
...
DROP FUNCTION IF EXISTSLL THEN
...
DROP FUNCTION IF EXISTSCountryCode" FROM pay."PaymentProviders" WHERE "Id" = v_provider_id LIMIT 1), 'XX'),
