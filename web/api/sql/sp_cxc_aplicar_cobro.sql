...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT @NombreCliente = NOMBRE FROM Clientes WHERE CODIGO = @CodCliente;
        ...
        BEGIN
            ...
            BEGIN
                ...
                BEGIN
                    ...
                    -- Para cobros (ingresos): DEP (depósito) o NCR (nota crédito)
                    SET @TipoMovBank = CASE @FpFormaPago
                        WHEN 'CHEQUE' THEN 'NCR'  -- Cheque de terceros = nota crédito
        ...
        -- ============================================
        -- 5. Recalcular saldos del cliente
        -- ============================================
