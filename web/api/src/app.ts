...
import { fiscalGeneratorsRouter } from "./modules/fiscal/generators.routes.js";
import { taxRatesRouter } from "./modules/fiscal/tax-rates.routes.js";
import { islrTariffRouter } from "./modules/fiscal/islr-tariff.routes.js";
import { declarationTemplatesRouter } from "./modules/fiscal/declaration-templates.routes.js";
import { socialSecurityRouter } from "./modules/social-security/routes.js";
import { conceptTemplatesRouter } from "./modules/nomina/concept-templates.routes.js";
import { activityCodesRouter } from "./modules/config/activity-codes.routes.js";
import { validatorsRouter } from "./modules/validators/routes.js";
...
export async function createApp() {
  ...
  app.use("/v1/fiscal/generators", fiscalGeneratorsRouter);
  app.use("/v1/fiscal/tax-rates", taxRatesRouter);
  app.use("/v1/fiscal/islr-tariff", islrTariffRouter);
  app.use("/v1/fiscal/declaration-templates", declarationTemplatesRouter);
  app.use("/v1/social-security", socialSecurityRouter);
  app.use("/v1/nomina/concept-templates", conceptTemplatesRouter);
  app.use("/v1/config/activity-codes", activityCodesRouter);
