-- +goose Up
-- Recrear funciones sec que dependen de columnas añadidas en 00003.
-- Las funciones existentes pueden estar "rotas" si fueron compiladas
-- antes de que las columnas existieran.

-- +goose StatementBegin
-- Recrear usp_sec_user_listcompanyaccesses (versión con parámetro)
...
-- +goose StatementBegin
-- Recrear usp_sec_user_listcompanyaccesses_default (versión sin parámetro)
...
-- +goose Down
-- Las funciones se mantienen (se sobreescribirán en futuras migraciones)
SELECT 1;
