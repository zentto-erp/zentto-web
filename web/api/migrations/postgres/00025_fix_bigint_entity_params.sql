...
-- â”€â”€ usp_bank_statementline_insert: TIMESTAMPTZ â†’ TIMESTAMP â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ usp_crm_activity_list: p_customer_id INT â†’ BIGINT â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
DROP FUNCTION IF EXISTS usp_crm_activity_list(INT, INT, INT, BOOLEAN, TIMESTAMP, INT, INT) CASCADE;

-- â”€â”€ usp_crm_activity_create: p_customer_id INT â†’ BIGINT â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
DROP FUNCTION IF EXISTS usp_crm_activity_create(INT, INT, INT, VARCHAR, VARCHAR, TEXT, TIMESTAMP, INT, VARCHAR, INT) CASCADE;

-- â”€â”€ usp_fleet_maintenanceorder_create: p_supplier_id INT â†’ BIGINT â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
DROP FUNCTION IF EXISTS usp_fleet_maintenanceorder_create CASCADE;

-- â”€â”€ usp_inv: multiple product_id / movement_id / customer_id INT â†’ BIGINT â”€â”€â”€â”€
...
-- â”€â”€ usp_logistics: p_supplier_id / p_customer_id INT â†’ BIGINT â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ usp_mfg: p_product_id INT â†’ BIGINT â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ usp_inv_integracion â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
DROP FUNCTION IF EXISTS usp_inv_serial_reserveforsale CASCADE;
DROP FUNCTION IF EXISTS usp_inv_lot_validateforsale CASCADE;

-- â”€â”€ usp_inv_movement_list: renombrar versiÃ³n ops (VARCHAR search) â†’ usp_movinvent_list â”€â”€â”€â”€â”€
...
-- +goose Down
-- No hay rollback automatico â€” los tipos anteriores son incompatibles con datos existentes
