-- usp_store_seller_admin_set_status — SQL Server 2012+
IF OBJECT_ID('dbo.usp_store_seller_admin_set_status', 'P') IS NOT NULL
    DROP PROCEDURE dbo.usp_store_seller_admin_set_status;
GO

CREATE PROCEDURE dbo.usp_store_seller_admin_set_status
    @CompanyId INT,
    @SellerId  BIGINT,
    @Status    NVARCHAR(20),
    @Actor     NVARCHAR(60),
...
BEGIN
    ...
    UPDATE store.Seller
     ...
     WHERE Id = @SellerId AND CompanyId = @CompanyId;
