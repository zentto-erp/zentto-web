...
BEGIN
  ...
  ON CONFLICT ("CompanyId", "BranchId", "CountryCode") DO NOTHING;
...
-- ============================================================
INSERT INTO fiscal."TaxRate" ("CountryCode", "TaxCode", "TaxName", "Rate", "AppliesToPOS", "AppliesToRestaurant", "IsDefault", "SortOrder")
VALUES ('VE', 'IVA_GENERAL',   'IVA General',   0.1600, TRUE, TRUE, TRUE, 10)
ON CONFLICT ("CountryCode", "TaxCode") DO NOTHING;
...
INSERT INTO fiscal."TaxRate" ("CountryCode", "TaxCode", "TaxName", "Rate", "SurchargeRate", "AppliesToPOS", "AppliesToRestaurant", "IsDefault", "SortOrder")
...
-- ============================================================
INSERT INTO fiscal."InvoiceType" ("CountryCode", "InvoiceTypeCode", "InvoiceTypeName", "IsRectificative", "RequiresRecipientId", "RequiresFiscalPrinter", "SortOrder")
VALUES ('VE', 'FACTURA',      'Factura Fiscal',           FALSE, TRUE,  TRUE,  10)
ON CONFLICT ("CountryCode", "InvoiceTypeCode") DO NOTHING;
...
-- ============================================================
INSERT INTO fiscal."InvoiceType" ("CountryCode", "InvoiceTypeCode", "InvoiceTypeName", "IsRectificative", "RequiresRecipientId", "MaxAmount", "RequiresFiscalPrinter", "SortOrder")
