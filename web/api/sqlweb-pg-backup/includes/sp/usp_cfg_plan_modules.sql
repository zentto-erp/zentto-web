-- ============================================================
-- usp_cfg_plan_modules.sql Ã¢â‚¬â€ MÃƒÂ³dulos por plan + apply a tenant
-- Motor: PostgreSQL (plpgsql)
-- Paridad: web/api/sqlweb/includes/sp/usp_cfg_plan_modules.sql
-- ============================================================

-- SP: obtener mÃƒÂ³dulos de un plan
...
BEGIN
  ...
  ELSE
    -- Fallback hardcoded por si la tabla estÃƒÂ¡ vacÃƒÂ­a
    RETURN QUERY
...
-- SP: aplicar mÃƒÂ³dulos de un plan al usuario admin del tenant
