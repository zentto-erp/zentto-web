-- ============================================================
-- DatqBoxWeb PostgreSQL - seed_gananciales_y_deducciones_completo.sql
-- Wrapper canonico: gananciales/deducciones centralizados en el
-- seed canonico de convenios (hr.PayrollConstant + hr.PayrollConcept)
-- ============================================================

-- Este wrapper replica la misma logica que seed_constantes_y_conceptos_legal.sql
-- ya que en SQL Server ambos archivos incluyen los mismos scripts subyacentes.
...
-- ── PARTE 2: Conceptos por convenio (gananciales y deducciones) ──
...
BEGIN
  ...
  RAISE NOTICE 'Gananciales/deducciones canonicos actualizados en hr.PayrollConcept';
END $$;
