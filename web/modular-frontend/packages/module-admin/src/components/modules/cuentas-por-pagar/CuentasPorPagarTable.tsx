// components/modules/cuentas-por-pagar/CuentasPorPagarTable.tsx
"use client";
  ...
  return (
    <Box sx={{ p: 2 }}>
        ...
        <Table>
          <TableHead>
            <TableRow sx={{ backgroundColor: "#f5f5f5" }}>
              ...
              <TableCell sx={{ fontWeight: 600 }}>Número Ref.</TableCell>
      ...
      <Dialog open={deleteDialogOpen} onClose={() => setDeleteDialogOpen(false)}>
        ...
        <DialogContent>
          ¿Estás seguro de que deseas eliminar esta cuenta por pagar?
        </DialogContent>
        <DialogActions>
