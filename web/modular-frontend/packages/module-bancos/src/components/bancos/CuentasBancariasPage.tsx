  ...
  return (
    <Box sx={{ flex: 1, display: "flex", flexDirection: "column", minHeight: 0 }}>
      <ContextActionHeader
        ...
        secondaryActions={[
          { label: "Conciliación Bancaria", onClick: () => { window.location.href = "/bancos/conciliacion" } }
        ]}
      />
      <Box sx={{ p: { xs: 2, md: 3 }, flex: 1, display: "flex", flexDirection: "column", minHeight: 0, overflow: 'auto' }}>
        <Grid container spacing={3}>
          <Grid item xs={12} lg={4}>
            <Paper sx={{ p: 2, height: "100%", elevation: 0, border: '1px solid #E5E7EB' }}>
