...
// Hook de TanStack Query para el modulo de articulos.
...
function mapRowToArticulo(r: RawArticuloRow): Articulo {
  // Descripcion compuesta: viene del SP como DescripcionCompleta
  // o se calcula aqui como fallback
  ...
  return {
    ...
    // Campos separados (para edicion individual)
