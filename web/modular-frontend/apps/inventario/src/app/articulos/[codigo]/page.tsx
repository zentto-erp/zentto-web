...
export default function ArticuloDetallePage() {
    ...
    const { data: articulo, isLoading, isError } = useArticuloById(codigo);
        ...
        return (
            <Box sx={{ p: 3 }}>
                ...
                <Typography variant="h6" sx={{ mt: 2 }} color="error">
                    No se pudo cargar el articulo con codigo &ldquo;{codigo}&rdquo;.
                </Typography>
            </Box>
        );
    }
                ...
                <CardContent>
                    ...
                    <Grid container spacing={3}>
                        <Grid size={{ xs: 12, md: 4 }}>
                            ...
                            <FieldItem label="Codigo" value={articulo.codigo} />
                            <FieldItem label="Descripcion" value={articulo.descripcion} />
                            <FieldItem label="Categoria" value={articulo.categoria} />
                            ...
                            <FieldItem label="Linea" value={articulo.linea} />
                            <FieldItem label="Referencia" value={articulo.referencia} />
                            <FieldItem label="Codigo de Barras" value={articulo.barra} />
                        </Grid>
                        ...
                        <Grid size={{ xs: 12, md: 4 }}>
                            ...
                            <FieldItem label="Alicuota %" value={articulo.alicuota} />
                        </Grid>
                        ...
                        <Grid size={{ xs: 12, md: 4 }}>
                            ...
                            <FieldItem label="Minimo" value={articulo.minimo} />
                            <FieldItem label="Maximo" value={articulo.maximo} />
                            <FieldItem label="Ubicacion" value={articulo.ubicacion} />
                            <FieldItem label="Ubicacion Fisica" value={articulo.ubicaFisica} />
                            <FieldItem label="Servicio" value={articulo.servicio ? 'Si' : 'No'} />
