...
function AppContent({ children }: { children: React.ReactNode }) {
    ...
    // Hidratar configuración general + facturación desde BD al arrancar
    useHydrateModuleSettings('facturacion', company?.companyId ?? 1);
    ...
    return (
        <AppBarWrapper>
            {!showContent ? (
                ...
                <ToastProvider>
                    <ZenttoLayout navigationFields={navigation} appCode="ventas">
