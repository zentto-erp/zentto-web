...
import type { Articulo, ArticuloFilter } from "@/lib/types";
...
export default function ArticulosTable() {
  ...
  // Reset page cuando cambia un filtro
  ...
  // ========== Inicializar rango de precios desde opciones ==========
    ...
    <Box sx={{ width: "100%", height: "100%" }}>
      ...
      <Stack direction="row" spacing={1} alignItems="center" sx={{ mb: 2 }}>
        ...
        {isFetching && !isLoading && (
          <RefreshIcon sx={{ animation: "spin 1s linear infinite", "@keyframes spin": { "0%": { transform: "rotate(0deg)" }, "100%": { transform: "rotate(360deg)" } } }} color="primary" />
        )}
          ...
          <Collapse in={showAdvanced}>
            <Stack spacing={2} sx={{ mt: 1 }}>
              ...
              <TextField
                ...
                size="small"
                sx={{ maxWidth: 400 }}
                helperText="Usa * para cualquier texto, ? para un sólo carácter"
                InputProps={{
