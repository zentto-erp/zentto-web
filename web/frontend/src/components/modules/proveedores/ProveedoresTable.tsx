// components/modules/proveedores/ProveedoresTable.tsx
"use client";
...
import { Proveedor, ProveedorFilter } from "@/lib/types";
  ...
  return (
    <Box sx={{ p: 2 }}>
      ...
      <Dialog open={deleteOpen} onClose={() => setDeleteOpen(false)}>
        ...
        <DialogContent>
          <DialogContentText>
            ¿Estás seguro que deseas eliminar a <strong>{selectedProveedor?.nombre}</strong>?
