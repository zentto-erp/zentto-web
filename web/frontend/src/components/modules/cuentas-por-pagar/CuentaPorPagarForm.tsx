// components/modules/cuentas-por-pagar/CuentaPorPagarForm.tsx
"use client";
...
import { CreateCuentaPorPagarDTO, UpdateCuentaPorPagarDTO } from "@/lib/types";
...
export default function CuentaPorPagarForm({ id }: CuentaPorPagarFormProps) {
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.codigoProveedor?.trim()) {
      newErrors.codigoProveedor = "El código de proveedor es requerido";
    }
